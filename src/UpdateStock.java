...
public class UpdateStock extends JFrame {
    ...
    private void updateButtonActionPerformed(ActionEvent e){
        if(IDText.getText().equals("") || quantityText.getText().equals("0"))
            ...
            try{
                Connection connection = DriverManager.getConnection("jdbc:derby://localhost:1527/MotorPartSoftware","yash","yash");
                PreparedStatement select = connection.prepareStatement("select * from STOCK where ID=?");
                select.setInt(1,ID);
                ...
                PreparedStatement update = connection.prepareStatement("update STOCK set Quantity=? where ID=?");
